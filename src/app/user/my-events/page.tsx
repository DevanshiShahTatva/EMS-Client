                    ...
                    <div className="flex flex-col md:flex-row gap-5 my-5 ">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 items-center my-2">
                          ...
                          <p className="text-gray-800 ">{item.bookingStatus === "cancelled" ? "Platform Fee" : " Total Paid"} : ₹ {item.eventTicketPrice.toFixed(2)} {item.eventTicketDiscount > 0 && (`(₹ ${item.eventTicketDiscount} discounted)`)}</p>
                        </div>
                      </div>
                    </div>
