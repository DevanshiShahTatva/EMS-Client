  ...
  return (
    <div className="px-8 py-5">
      ...
      <div className="flex flex-col gap-4 mt-5 w-full">
        <div className="border border-gray-100 rounded-lg shadow-md bg-white w-full">
          <button
            className="flex items-center gap-3 p-6 w-full text-indigo-700 focus:outline-none"
          ...
          {openStates[0] && (
            <div className="p-6 border-t border-gray-100 text-gray-600 text-sm leading-relaxed">
              <p className="mb-6">
                Note: The value entered here determines how many points are
                equivalent to ₹ 1. This sets the conversion rate for points to
                Indian Rupees.
              </p>
              <div className="flex flex-col gap-4 items-start">
                ...
                <CustomButton
                  disabled={
                    !points || Number(points) < 0 || !/^\d*$/.test(points)
                  }
        ...
        <div className="border border-gray-100 rounded-lg shadow-md bg-white">
          <button
            className="flex items-center gap-3 p-6 w-full text-teal-700 focus:outline-none"
          ...
          {openStates[1] && (
            <div className="p-6 border-t border-gray-100 text-gray-600 text-sm leading-relaxed">
              <p className="mb-6">
                Note: This is the percentage charge applied by the admin. Please
                ensure the value is between 0 and{" "}
