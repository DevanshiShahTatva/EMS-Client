          ...
          {tickets.map((ticket) => {
            ...
            return (
              <div
                ...
                {/* Accordion Header */}
                <div
                  className={`flex justify-between items-start px-4 py-3 cursor-pointer transition-colors ${
                ...
                <div
                  className={`transition-all duration-300 ease-in-out overflow-hidden ${
                    isOpen ? "max-h-40 opacity-100 py-3 px-4 bg-blue-50" : "max-h-0 opacity-0 px-4 bg-white"
                  }`}>
                  {isSelected && quantity > 0 ? (
                    ...
                    <button
                      ...
                      className={`px-4 py-1.5 text-sm font-medium rounded border w-fit ${
                        available === 0
