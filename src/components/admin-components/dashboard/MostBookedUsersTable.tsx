    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <span
            className={`block truncate whitespace-pre-wrap overflow-hidden max-w-[${maxWidthVal}]`}
          >
            {text}
          </span>
        </TooltipTrigger>
        ...
        <TableBody>
          {users.length ? (
            users.map((user, index) => (
              <TableRow
                key={user.userId}
                className="hover:bg-transparent text-gray-800"
              >
