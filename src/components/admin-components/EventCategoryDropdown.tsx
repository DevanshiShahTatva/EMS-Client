...
function EventCategoryDropdown() {
  ...
  const [formValues, setFormValues] = useState<TCategoryFormValues>(
    initialCategoryFormValues
  );
  ...
  const createCategory = useCallback(
    async (form: TCategoryFormValues) => {
  ...
  const tableHeaders: Column<IEventCategory>[] = [
    ...
    },
    {
      header: "Status",
      key: "isUsed",
      render: (item: IEventCategory) => (item.isUsed ? "In Use" : "Not Used"),
    },
  ];
