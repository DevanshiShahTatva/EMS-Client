...
const adminRoutes = [ROUTES.ADMIN.DASHBOARD, ROUTES.ADMIN.EVENTS, ROUTES.ADMIN.CONTACT_US, ROUTES.ADMIN.FAQs, ROUTES.ADMIN.CREATE_FAQs, ROUTES.ADMIN.TERMS_AND_CONDITIONS, ROUTES.ADMIN.POINT_CONFIGURATION];
const userRoutes = [ROUTES.USER_MY_EVENTS, ROUTES.USER_MY_CALENDER, ROUTES.USER_PROFILE, ROUTES.USER_EVENTS,ROUTES.USER_EVENTS_DETAILS, ROUTES.USER_REWARDED_HISTORY];
